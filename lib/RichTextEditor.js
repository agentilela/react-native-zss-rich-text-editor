...
import { Dimensions, Keyboard, Modal, Platform, Text, TextInput, TouchableOpacity, View, WebView, } from 'react-native';
...
export default class RichTextEditor extends PureComponent {
    constructor(props) {
        ...
        this.handleKeyboardWillShow = (event) => {
            ...
            return this.setState({ keyboardHeight: newKeyboardHeight }, () => this.setEditorAvailableHeightBasedOnKeyboardHeight(newKeyboardHeight));
        };
        ...
        this.setEditorAvailableHeightBasedOnKeyboardHeight = (keyboardHeight) => {
            ...
            this.setEditorHeight(Dimensions.get('window').height - keyboardHeight - spacing);
        };
        //-------------------------------------------------------------------------------
        // Public API
        //-------------------------------------------------------------------------------
    ...
    render() {
        ...
        return (React.createElement(View, { style: styles.editorContainer },
            React.createElement(WebView, Object.assign({ javaScriptEnabled: true, injectedJavaScript: injectScript, onLoad: this.init, onMessage: this.onBridgeMessage, ref: this.captureWebviewRef, source: pageSource }, this.props)),
            linkModal));
    }
}
